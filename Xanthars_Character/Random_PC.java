...
public class Random_PC {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("You are a "+age+" year old " +gender +subrace + " "+rclass);
		System.out.println("You are also a(n) " +background + Background.reason(background));
		System.out.println(stats());
		System.out.println();
		System.out.println(Parents.parents(race));
		System.out.println(Family.fullFamily());
		System.out.println();
		System.out.println("You have "+numsiblings+" siblings\n");
		System.out.println(Family.childhood_Memories(CHA)+"\n");
		System.out.println("You lived in a "+Family.lifestyle());
		System.out.println();
		System.out.println(life(age));
		for(int i = 1; i <= numsiblings; i++)
		{
			System.out.println("Sibling "+i+": "+Sibling.sibling_stats(subrace, race)+"\n");
		}
	}
